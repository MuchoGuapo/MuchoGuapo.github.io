...
pid: privacypolicy
excerpt: 'レッツDIYクラブのプライバシーポリシーです。'
tags:
- no_index
---

レッツDIYクラブ（以下「当サイト」といいます。）は、当サイトに掲載する写真、文章などの情報の閲覧における、当サイト訪問者（ユーザー）の個人情報を含む利用者情報の取扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」といいます。）を定めます。
